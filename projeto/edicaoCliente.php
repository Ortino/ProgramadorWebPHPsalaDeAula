...
<?php 
        ...
        <div class="container-fluid">
			...
			<form class="row g-3 container-fluid" name="f" action="src/controler/cliente_bd/editaCliente.php" method="post">

				<div class="col-md-6 col-sm-12">
					<label for="nome_id" class="form-label">Nome completo</label>
					<input type="text" class="form-control" id="nome_id" name="idcliente" value="<?=$cliente["nome"]; ?> " required>
				</div>
				<div class="col-md-6 col-sm-12">
				...
				<div class="col-md-3 col-sm-12">
					...
					<select class="form-select" id="estadoc" name="estado_civil" value="<?=$cliente["estadocivil"]; ?>required>
						<option disabled value="">Selecione</option>
						<option value="Solteiro" <?php if($cliente['estado_civil'] == "Solteiro"){echo "selected";}?>>Solterio(a)</option>
				...
				<div class="col-md-6 col-sm-12">
					...
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="sexo" id="sexo_id1" value="M" <?=($cliente['sexo'] == 'M') ? 'checked' : ''?>)>
					...
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="sexo" id="sexo_id2" value="F"<?=($cliente['sexo'] == 'O') ? 'checked' : ''?>)> 
